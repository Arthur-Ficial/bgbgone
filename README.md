...
[![Version 1.1.9](https://img.shields.io/badge/version-1.1.9-blue)](https://github.com/Arthur-Ficial/bgbgone)
...
Average over 5 release-binary runs: **100 images in 1.221 s, 81.92 images/s, 12.2 ms/image** with 95,487,542 output bytes verified per run. On-device, no network, no GPU contention with another process.
