...
- **README examples must be real.** Every image in `docs/images/` is re-generated by `scripts/make-readme-examples.sh` from real bgbgone invocations against the PD fixtures. No fabricated outputs.
