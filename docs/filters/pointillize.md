...
```bash
bgbgone yoga.jpg --type person --filter "bg:pointillize"
bgbgone yoga.jpg --type person --filter "fg:pointillize"
bgbgone yoga.jpg --type person --filter "all:pointillize"
```
