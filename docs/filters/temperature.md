...
```bash
bgbgone yoga.jpg --algo person --filter "bg:temperature"
bgbgone yoga.jpg --algo person --filter "fg:temperature"
bgbgone yoga.jpg --algo person --filter "all:temperature"
```
