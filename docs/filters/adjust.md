...
## Example — `fg:adjust=brightness=0.1:contrast=1.1:saturation=0.9`
...
```bash
bgbgone yoga.jpg --type person --bg "image:yoga.jpg" --filter "bg:adjust=brightness=0.1:contrast=1.2:saturation=0.6"
bgbgone yoga.jpg --type person --bg color:#1a2233 --filter "fg:adjust=brightness=0.1:contrast=1.2:saturation=0.6"
bgbgone yoga.jpg --type person --bg "image:yoga.jpg" --filter "all:adjust=brightness=0.1:contrast=1.2:saturation=0.6"
```
...
```bash
bgbgone woman-singer.jpg --type person --bg "image:woman-singer.jpg" --filter "bg:adjust=brightness=0.1:contrast=1.2:saturation=0.6"
bgbgone woman-singer.jpg --type person --bg color:#1a2233 --filter "fg:adjust=brightness=0.1:contrast=1.2:saturation=0.6"
bgbgone woman-singer.jpg --type person --bg "image:woman-singer.jpg" --filter "all:adjust=brightness=0.1:contrast=1.2:saturation=0.6"
```
