...
```bash
bgbgone yoga.jpg --algo person --filter "bg:crystallize"
bgbgone yoga.jpg --algo person --filter "fg:crystallize"
bgbgone yoga.jpg --algo person --filter "all:crystallize"
```
