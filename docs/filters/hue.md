...
```bash
bgbgone yoga.jpg --algo person --filter "bg:hue"
bgbgone yoga.jpg --algo person --filter "fg:hue"
bgbgone yoga.jpg --algo person --filter "all:hue"
```

![hue on yoga](../images/filters/panels/yoga-hue.jpg)
...
![hue on Parastoo](../images/filters/panels/parastoo-hue.jpg)
