...
```bash
bgbgone yoga.jpg --type person --bg "image:yoga.jpg" --filter "bg:sepia=0.85"
bgbgone yoga.jpg --type person --bg color:#1a2233 --filter "fg:sepia=0.85"
bgbgone yoga.jpg --type person --bg "image:yoga.jpg" --filter "all:sepia=0.85"
```
...
```bash
bgbgone woman-singer.jpg --type person --bg "image:woman-singer.jpg" --filter "bg:sepia=0.85"
bgbgone woman-singer.jpg --type person --bg color:#1a2233 --filter "fg:sepia=0.85"
bgbgone woman-singer.jpg --type person --bg "image:woman-singer.jpg" --filter "all:sepia=0.85"
```
