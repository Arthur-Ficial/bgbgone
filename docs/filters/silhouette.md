...
## Example — `fg:silhouette=color=#ff0000`
...
```bash
bgbgone yoga.jpg --type person --bg color:#1a2233 --filter "fg:silhouette=color=#005577"
```
...
```bash
bgbgone woman-singer.jpg --type person --bg color:#1a2233 --filter "fg:silhouette=color=#005577"
```
