...
```bash
bgbgone yoga.jpg --algo person --bg color:#1a2233 --filter "fg:silhouette"
```

![silhouette on yoga](../images/filters/panels/yoga-silhouette.jpg)
...
![silhouette on Parastoo](../images/filters/panels/parastoo-silhouette.jpg)
