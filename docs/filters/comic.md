...
```bash
bgbgone yoga.jpg --algo person --filter "bg:comic"
bgbgone yoga.jpg --algo person --filter "fg:comic"
bgbgone yoga.jpg --algo person --filter "all:comic"
```

![comic on yoga](../images/filters/panels/yoga-comic.jpg)
...
![comic on Parastoo](../images/filters/panels/parastoo-comic.jpg)
