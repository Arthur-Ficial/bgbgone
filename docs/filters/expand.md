...
```bash
bgbgone yoga.jpg --algo person --bg color:#1a2233 --filter "mask:expand"
```

![expand on yoga](../images/filters/panels/yoga-expand.jpg)
...
![expand on Parastoo](../images/filters/panels/parastoo-expand.jpg)
