...
## Example — `composite:gloom=intensity=0.5:radius=10`
...
```bash
bgbgone yoga.jpg --type person --bg color:#1a2233 --filter "composite:gloom=1.0:18"
```
...
```bash
bgbgone woman-singer.jpg --type person --bg color:#1a2233 --filter "composite:gloom=1.0:18"
```
