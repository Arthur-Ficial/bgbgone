...
```bash
bgbgone red-panda.jpg --bg "image:red-panda.jpg" --filter "composite:gloom=1.0:18"
```

| Baseline | After `composite:gloom=1.0:18` |
|---|---|
...
```bash
bgbgone yoga.jpg --type person --filter "composite:gloom"
```
