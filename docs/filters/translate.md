...
```bash
bgbgone yoga.jpg --type person --bg color:#1a2233 --filter "fg:translate=120,-60"
```
...
```bash
bgbgone woman-singer.jpg --type person --bg color:#1a2233 --filter "fg:translate=120,-60"
```
