...
```bash
bgbgone yoga.jpg --type person --bg "image:yoga.jpg" --filter "bg:motion-blur=radius=22:angle=45"
bgbgone yoga.jpg --type person --bg color:#1a2233 --filter "fg:motion-blur=radius=22:angle=45"
bgbgone yoga.jpg --type person --bg "image:yoga.jpg" --filter "all:motion-blur=radius=22:angle=45"
```
...
```bash
bgbgone woman-singer.jpg --type person --bg "image:woman-singer.jpg" --filter "bg:motion-blur=radius=22:angle=45"
bgbgone woman-singer.jpg --type person --bg color:#1a2233 --filter "fg:motion-blur=radius=22:angle=45"
bgbgone woman-singer.jpg --type person --bg "image:woman-singer.jpg" --filter "all:motion-blur=radius=22:angle=45"
```
