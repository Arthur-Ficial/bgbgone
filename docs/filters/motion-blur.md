...
```bash
bgbgone yoga.jpg --algo person --filter "bg:motion-blur"
bgbgone yoga.jpg --algo person --filter "fg:motion-blur"
bgbgone yoga.jpg --algo person --filter "all:motion-blur"
```
