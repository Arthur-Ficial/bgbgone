...
```bash
bgbgone yoga.jpg --type person --filter "bg:blur"
bgbgone yoga.jpg --type person --filter "fg:blur"
bgbgone yoga.jpg --type person --filter "all:blur"
```

![blur on yoga](../images/filters/panels/yoga-blur.jpg)
...
![blur on Parastoo](../images/filters/panels/parastoo-blur.jpg)
