...
public struct Config: Sendable, Equatable {
    ...
    public var cropMargins: EdgeInsetsSpec?
    public var cropToSubject: Bool
    public var roi: RectSpec?
...
public struct ServerConfig: Sendable, Equatable {
    ...
    public init(
        host: String = CLIContract.serverDefaultHost,
        port: Int = CLIContract.serverDefaultPort,
        cors: Bool = false,
        ...
        maxBodyBytes: Int = CLIContract.serverDefaultMaxBodyMB * 1024 * 1024
    ) {
        self.host = host
        self.port = port
        self.cors = cors
